                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        className="pl-10 pr-3 py-2 bg-white border border-neutral-300 rounded text-sm focus:ring-1 focus:ring-pink-600 focus:outline-none w-full sm:w-64"
                                        readOnly
                                    />
                                    <svg
                                        width="16"
                                            ...
                                            <tr key={index} className="hover:bg-neutral-50">
                                                ...
                                                <td className="p-4 border border-neutral-200 text-sm text-neutral-900">
                                                    <button
                                                        ...
                                                        className="text-pink-700 hover:text-pink-800 text-xs font-medium transition-colors"
                                                    >
                                                        View
                                                    </button>
                                                </td>
