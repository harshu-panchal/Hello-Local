          ...
          <section>
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center pt-4 mt-2 border-t-2 border-neutral-100">
                ...
                <span className="text-2xl font-black text-purple-700">₹{notification.totalAmount.toFixed(2)}</span>
              </div>
            </div>
          </section>
        </div>
          ...
          {notification.type === 'NEW_ORDER' ? (
             <div className="flex gap-4">
               <button
                 ...
                 disabled={loading}
                 className="flex-1 py-4 rounded-xl font-bold text-white shadow-lg bg-purple-600 hover:bg-purple-700 transition-transform active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
               >
            ...
            <button
              onClick={onClose}
              className="w-full py-4 rounded-xl font-bold text-white shadow-lg transition-transform active:scale-95 bg-purple-600 hover:bg-purple-700"
            >
              Acknowledge & Dismiss
            </button>
          )}
