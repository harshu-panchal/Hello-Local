  ...
  return (
    <div className="bg-white shadow-sm">
      ...
      <div className="px-4 py-3">
        {/* App Title */}
        <h1 className={`text-xl font-bold text-center mb-3 transition-colors ${isOnline ? 'text-rose-600' : 'text-neutral-500'
          }`}>
          Delivery App
        </h1>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            {/* Profile Icon */}
            <div className={`w-10 h-10 rounded-full flex items-center justify-center transition-colors ${isOnline ? 'bg-rose-600' : 'bg-neutral-400'
              }`}>
