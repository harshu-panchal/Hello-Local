          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-base sm:text-lg font-bold text-slate-900 tracking-tight">
                Stationery, Craft & Hobby Store
              </h1>
              <p className="text-[10px] text-slate-400 font-medium">
                Art supplies, office stationery, books & craft kits
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-[1440px] mx-auto px-3.5 sm:px-6 lg:px-8 pt-3.5 md:pt-6">
        {loading ? (
          <div className="flex flex-col items-center justify-center py-20 gap-2.5">
            ...
            <p className="text-xs font-bold text-slate-400">Loading hobby essentials...</p>
          </div>
          ...
          <div className="py-10">
            <UserEmptyState
              ...
              title="No hobby items found in your area"
              description="Stationery & hobby kits are currently refreshing or unavailable nearby. Please check back shortly."
