...
import { ArrowLeftIcon, ShieldCheckIcon } from './components/common/UserIcons';
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[10px] text-slate-400 font-medium">
                Healthcare, OTC essentials & babycare
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-[1440px] mx-auto px-3.5 sm:px-6 lg:px-8 pt-3.5 md:pt-6">
        {loading ? (
          <div className="flex flex-col items-center justify-center py-20 gap-2.5">
            ...
            <p className="text-xs font-bold text-slate-400">Loading pharmacy essentials...</p>
          </div>
          ...
          <div className="py-10">
            <UserEmptyState
              icon={<ShieldCheckIcon size={32} className="text-[#FF2E7A]" />}
              title="No pharmacy items found in your area"
              description="Pharmacy essentials are currently refreshing or unavailable nearby. Please check back shortly."
